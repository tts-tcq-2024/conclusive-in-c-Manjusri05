...
- Enter Reflections: Replace the queries in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
1.Limiting the CCN value makes the code more understandable and clean.
2.Clear naming to the varibles in the code makes the code looks more effective and also understanble to the others and reuse.
3. Writing the test cases to test all the possible secenries makes its effective testing


During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
1. Improving the test case standards
2. Making the code more clean and understandable
